...
class OHD_SJTUDataset(CustomDataset):
    ...
    """
    CLASSES = ('ship', 'plane', 'small-vehicle', 'large-vehicle', 'harbor', 'helicopter')
    ...
    def __init__(self,
        ...
        super(OHD_SJTUDataset, self).__init__(ann_file, pipeline, **kwargs)
